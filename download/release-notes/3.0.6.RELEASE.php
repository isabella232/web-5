...
<h3>3.0.6.RELEASE - Release Notes</h3>

<p>The 3.0.6 release of Gemini Web upgrades Gemini Web to pick up Apache Tomcat 8.5.56.</p>
<p>
<h4>Notable Improvements</h4>

<ul>
	<li>Upgrade to Apache Tomcat 8.5.56</li>
</ul>

<p>A full list of bugs included in this release is available <a href="https://bugs.eclipse.org/bugs/buglist.cgi?list_id=2407161;classification=RT;query_format=advanced;component=unknown;target_milestone=3.0.6.RELEASE;product=Gemini.Web" target="_self">here</a>.</p>
<p>
<h4>Migration from Gemini Web 3.0.0 to Gemini Web 3.0.6</h4>
...
<p><a href="3.0.3.RELEASE.php" target="_self">3.0.3.RELEASE - Release Notes</a></p>
<p><a href="3.0.4.RELEASE.php" target="_self">3.0.4.RELEASE - Release Notes</a></p>
<p><a href="3.0.5.RELEASE.php" target="_self">3.0.5.RELEASE - Release Notes</a></p>
